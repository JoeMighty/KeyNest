    ...
    <div className="min-h-screen flex flex-col selection:bg-primary selection:text-white">
      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-slate-950 text-white">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1464146072230-91cabc968266?q=80&w=1920&auto=format&fit=crop')] bg-cover bg-center opacity-30 scale-105" />
